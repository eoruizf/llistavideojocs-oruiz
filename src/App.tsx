...
/**
 * Tipus que representa l'estat de l'acció del formulari
 */
...
function App() {
    ...
    // Estat que guarda el llistat de videojocs creats
  const [videojocs, setVideojocs] = useState<JSX.Element[]>([]);



    // Estat del formulari (controla si s'ha enviat correctament)
